# nvim-treesitter-queries-v

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-v/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-v/actions/workflows/validate.yml)

Neovim tree-sitter queries for **v**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-v",
...
- [ ] Changes are scoped to `v` — do not include files for other languages
